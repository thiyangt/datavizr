...
date: <span style="color:#8dcefc"> 25-28, May, 2023</span> </br></br>`r knitr::include_graphics("fig/ggplot2.png")` `r knitr::include_graphics("fig/15_palmerpenguins2.png")`
output:
...
---
background-image:url('grammar1.png')
background-size: contain

---
background-image:url('grammar2.png')
background-size: contain
